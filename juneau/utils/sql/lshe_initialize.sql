DROP FUNCTION IF EXISTS format_json;
DROP FUNCTION IF EXISTS corpus_construct_hash_single;
DROP FUNCTION IF EXISTS corpus_construct_hash;
DROP FUNCTION IF EXISTS corpus_construct_sig_single;
DROP FUNCTION IF EXISTS corpus_construct_sig;
DROP FUNCTION IF EXISTS min_hash_char;
DROP FUNCTION IF EXISTS min_hash_array;
DROP FUNCTION IF EXISTS q_construct_hash;
DROP FUNCTION IF EXISTS q_construct_sig;
